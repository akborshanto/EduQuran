...
const NewsLetter = () => {
  return (
    <div>         <section className="max-w-xl mt-12 mx-auto px-4 md:px-8">
    ...
    <div className="mt-6">
        <form 
            ...
            />
     <textarea name="message" rows={5} cols={67} className='my-6 p-4 hover:border-b-4[#F0F0F0]' placeholder='Enter your message here...'>
