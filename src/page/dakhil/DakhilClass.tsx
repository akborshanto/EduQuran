...
export const DakhilClass = () => {
  return (
    <div>
      <Tabs.Root
        className="max-w-screen-xl mx-auto px-4 md:px-8"
        defaultValue="Class Six"  // Set "Class Six" as the default active tab
      >
        <Tabs.List
          ...
          {tabItems.map((item, idx) => (
            <Tabs.Trigger
              ...
              className={`group outline-none py-1.5 border-b-2 text-gray-500 
                ${item === "Class Six" ? 'border-indigo-600 text-indigo-600' : 'border-white text-gray-500'}
